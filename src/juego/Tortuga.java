	...
	public class Tortuga {
	 ...
	 // Método para verificar colisión con un gnomo
	    public boolean colisionConGnomo(Gnomo gnomo) {
	        return this.x + this.ancho / 2 > gnomo.getX() - gnomo.getAncho() / 2 &&
	               this.x - this.ancho / 2 < gnomo.getX() + gnomo.getAncho() / 2 &&
	               this.y + this.alto / 2 > gnomo.getY() - gnomo.getAlto() / 2 &&
	               this.y - this.alto / 2 < gnomo.getY() + gnomo.getAlto() / 2;
	    }
	 ...
	 // Método para verificar si la tortuga debe caer o quedarse en la isla
		...
		public boolean colisionaCon(Gnomo gnomo) {
